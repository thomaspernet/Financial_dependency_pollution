...
```sos kernel="R"
%get path table
t_0 <- felm(log(tso2) ~ asset_tangibility_i  +
            log(output) + log(capital)
            | geocode4_corr + year |0 | geocode4_corr, df_final,
            exactDOF = TRUE)
t_1 <- felm(log(tso2) ~ asset_tangibility_i  + current_ratio_i +
            log(output) +  log(capital)
            | geocode4_corr + year |0 | geocode4_corr, df_final,
            exactDOF = TRUE)
t_2 <- felm(log(tso2) ~ asset_tangibility_i  + current_ratio_i + cash_ratio_i +
            log(output)  + log(capital)
            | geocode4_corr + year |0 | geocode4_corr, df_final,
            exactDOF = TRUE)
t_3 <- felm(log(tso2) ~ asset_tangibility_i  + current_ratio_i + cash_ratio_i+liabilities_assets_i + sales_assets_i +
            log(output) + log(capital)
            | geocode4_corr + year |0 | geocode4_corr, df_final,
            exactDOF = TRUE)
