...
| 19 | above_average_mandate       | varchar(5)          | Policy mandate above national average                                                                                                                                                                     |
...
| 41 | asset_tangibility_tot_asset | decimal(21,5)       | asset tangibility tot total asset                                                                                                                                                                         |
...
| 44 | return_to_sale              | decimal(21,5)       | return to sale                                                                                                                                                                                            |
| 45 | lag_return_to_sale          | decimal(21,5)       | lag value of return to sale                                                                                                                                                                               |
| 46 | coastal                     | string              | City is bordered by sea or not                                                                                                                                                                            |
| 47 | dominated_output_soe_c      | boolean             | SOE dominated city of output. If true, then SOEs dominated city                                                                                                                                           |
| 48 | dominated_employment_soe_c  | boolean             | SOE dominated city of employment. If true, then SOEs dominated city                                                                                                                                       |
| 49 | dominated_sales_soe_c       | boolean             | SOE dominated city of sales. If true, then SOEs dominated city                                                                                                                                            |
| 50 | dominated_capital_soe_c     | boolean             | SOE dominated city of capital. If true, then SOEs dominated city                                                                                                                                          |
| 51 | dominated_output_for_c      | boolean             | foreign dominated city of output. If true, then foreign dominated city                                                                                                                                    |
| 52 | dominated_employment_for_c  | boolean             | foreign dominated city of employment. If true, then foreign dominated city                                                                                                                                |
| 53 | dominated_sales_for_c       | boolean             | foreign dominated cityof sales. If true, then foreign dominated city                                                                                                                                      |
| 54 | dominated_capital_for_c     | boolean             | foreign dominated city of capital. If true, then foreign dominated city                                                                                                                                   |
| 55 | dominated_output_i          | map<double,boolean> | map with information dominated industry knowing percentile .5, .75, .9, .95 of output                                                                                                                     |
| 56 | dominated_employment_i      | map<double,boolean> | map with information on dominated industry knowing percentile .5, .75, .9, .95 of employment                                                                                                              |
| 57 | dominated_capital_i         | map<double,boolean> | map with information on dominated industry knowing percentile .5, .75, .9, .95 of capital                                                                                                                 |
| 58 | dominated_sales_i           | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of sales                                                                                                               |
| 59 | dominated_output_soe_i      | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of output                                                                                                              |
| 60 | dominated_employment_soe_i  | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of employment                                                                                                          |
| 61 | dominated_sales_soe_i       | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of sales                                                                                                               |
| 62 | dominated_capital_soe_i     | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of capital                                                                                                             |
| 63 | dominated_output_for_i      | map<double,boolean> | map with information on foreign dominated industry knowing percentile .5, .75, .9, .95 of output                                                                                                          |
| 64 | dominated_employment_for_i  | map<double,boolean> | map with information on foreign dominated industry knowing percentile .5, .75, .9, .95 of employment                                                                                                      |
| 65 | dominated_sales_for_i       | map<double,boolean> | map with information on foreign dominated industry knowing percentile .5, .75, .9, .95 of sales                                                                                                           |
| 66 | dominated_capital_for_i     | map<double,boolean> | map with information on foreign dominated industry knowing percentile .5, .75, .9, .95 of capital                                                                                                         |
| 67 | fe_c_i                      | bigint              | City industry fixed effect                                                                                                                                                                                |
| 68 | fe_t_i                      | bigint              | year industry fixed effect                                                                                                                                                                                |
| 69 | fe_c_t                      | bigint              | city industry fixed effect                                                                                                                                                                                |
