...
| 38 | quick_ratio                 | decimal(21,5)       | quick ratio (cuasset-存货 (c81) ) / 流动负债合计 (c95)                                                                                                        |
...
| 65 | size_output_fc              | map<double,boolean> | if firm s ouptut average is above average of firm s city decile then firm is large                                                                            |
...
|  9 | polluted_di                 | varchar(5)          | Sectors with values above Yearly 75th percentile of SO2 label as ABOVE else BELOW                                                                                                                         |
| 10 | polluted_mi                 | varchar(5)          | Sectors with values above Yearly average of SO2 label as ABOVE else BELOW                                                                                                                                 |
| 11 | polluted_d90i               | varchar(5)          | Sectors with values above Yearly 90th percentile of SO2 label as ABOVE else BELOW                                                                                                                         |
| 12 | polluted_d95i               | varchar(5)          | Sectors with values above Yearly 95th percentile of SO2 label as ABOVE else BELOW                                                                                                                         |
| 13 | polluted_mei                | varchar(5)          | Sectors with values above Yearly median of SO2 label as ABOVE else BELOW                                                                                                                                  |
| 14 | tso2                        | bigint              | Total so2 city sector. Filtered values above  4863 (5% of the distribution)                                                                                                                               |
| 15 | so2_intensity               | decimal(21,5)       | SO2 divided by output                                                                                                                                                                                     |
| 16 | tso2_mandate_c              | float               | city reduction mandate in tonnes                                                                                                                                                                          |
| 17 | above_threshold_mandate     | map<double,boolean> | Policy mandate above percentile .5, .75, .9, .95                                                                                                                                                          |
| 18 | above_average_mandate       | varchar(5)          | Policy mandate above national average                                                                                                                                                                     |
| 19 | in_10_000_tonnes            | float               | city reduction mandate in 10k tonnes                                                                                                                                                                      |
| 20 | tfp_cit                     | double              | TFP at the city industry level. From https://github.com/thomaspernet/Financial_dependency_pollution/blob/master/01_data_preprocessing/02_transform_tables/05_tfp_computation.md#table-asif_tfp_firm_level |
| 21 | credit_constraint           | float               | Financial dependency. From paper https://www.sciencedirect.com/science/article/pii/S0147596715000311"                                                                                                     |
| 22 | supply_all_credit           | double              | province external supply of credit                                                                                                                                                                        |
| 23 | supply_long_term_credit     | float               | province external supply of long term credit                                                                                                                                                              |
| 24 | output                      | decimal(16,5)       | Output                                                                                                                                                                                                    |
| 25 | employment                  | decimal(16,5)       | Employemnt                                                                                                                                                                                                |
| 26 | sales                       | decimal(16,5)       | Sales                                                                                                                                                                                                     |
| 27 | capital                     | decimal(16,5)       | Capital                                                                                                                                                                                                   |
| 28 | current_asset               | int                 | current asset                                                                                                                                                                                             |
| 29 | tofixed                     | bigint              | total fixed asset                                                                                                                                                                                         |
| 30 | total_liabilities           | int                 | total liabilities                                                                                                                                                                                         |
| 31 | total_asset                 | int                 | total asset                                                                                                                                                                                               |
| 32 | tangible                    | int                 | tangible asset                                                                                                                                                                                            |
| 33 | cashflow                    | int                 | cashflow                                                                                                                                                                                                  |
| 34 | current_ratio               | decimal(21,5)       | current ratio                                                                                                                                                                                             |
| 35 | lag_current_ratio           | decimal(21,5)       | lag value of current ratio                                                                                                                                                                                |
| 36 | liabilities_tot_asset       | decimal(21,5)       | liabilities to total asset                                                                                                                                                                                |
| 37 | lag_liabilities_tot_asset   | decimal(21,5)       | lag value of liabilities to asset                                                                                                                                                                         |
| 38 | sales_tot_asset             | decimal(21,5)       | sales to total asset                                                                                                                                                                                      |
| 39 | lag_sales_tot_asset         | decimal(21,5)       | lag value of sales to asset                                                                                                                                                                               |
| 40 | asset_tangibility_tot_asset | decimal(21,5)       | asset tangibility tot total asset                                                                                                                                                                         |
| 41 | cashflow_to_tangible        | decimal(21,5)       | cashflow to tangible asset                                                                                                                                                                                |
| 42 | lag_cashflow_to_tangible    | decimal(21,5)       | lag value of cashflow to tangible asset                                                                                                                                                                   |
| 43 | return_to_sale              | decimal(21,5)       | return to sale                                                                                                                                                                                            |
| 44 | lag_return_to_sale          | decimal(21,5)       | lag value of return to sale                                                                                                                                                                               |
| 45 | coastal                     | string              | City is bordered by sea or not                                                                                                                                                                            |
| 46 | dominated_output_soe_c      | boolean             | SOE dominated city of output. If true, then SOEs dominated city                                                                                                                                           |
| 47 | dominated_employment_soe_c  | boolean             | SOE dominated city of employment. If true, then SOEs dominated city                                                                                                                                       |
| 48 | dominated_sales_soe_c       | boolean             | SOE dominated city of sales. If true, then SOEs dominated city                                                                                                                                            |
| 49 | dominated_capital_soe_c     | boolean             | SOE dominated city of capital. If true, then SOEs dominated city                                                                                                                                          |
| 50 | dominated_output_for_c      | boolean             | foreign dominated city of output. If true, then foreign dominated city                                                                                                                                    |
| 51 | dominated_employment_for_c  | boolean             | foreign dominated city of employment. If true, then foreign dominated city                                                                                                                                |
| 52 | dominated_sales_for_c       | boolean             | foreign dominated cityof sales. If true, then foreign dominated city                                                                                                                                      |
| 53 | dominated_capital_for_c     | boolean             | foreign dominated city of capital. If true, then foreign dominated city                                                                                                                                   |
| 54 | dominated_output_i          | map<double,boolean> | map with information dominated industry knowing percentile .5, .75, .9, .95 of output                                                                                                                     |
| 55 | dominated_employment_i      | map<double,boolean> | map with information on dominated industry knowing percentile .5, .75, .9, .95 of employment                                                                                                              |
| 56 | dominated_capital_i         | map<double,boolean> | map with information on dominated industry knowing percentile .5, .75, .9, .95 of capital                                                                                                                 |
| 57 | dominated_sales_i           | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of sales                                                                                                               |
| 58 | dominated_output_soe_i      | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of output                                                                                                              |
| 59 | dominated_employment_soe_i  | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of employment                                                                                                          |
| 60 | dominated_sales_soe_i       | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of sales                                                                                                               |
| 61 | dominated_capital_soe_i     | map<double,boolean> | map with information on SOE dominated industry knowing percentile .5, .75, .9, .95 of capital                                                                                                             |
| 62 | dominated_output_for_i      | map<double,boolean> | map with information on foreign dominated industry knowing percentile .5, .75, .9, .95 of output                                                                                                          |
| 63 | dominated_employment_for_i  | map<double,boolean> | map with information on foreign dominated industry knowing percentile .5, .75, .9, .95 of employment                                                                                                      |
| 64 | dominated_sales_for_i       | map<double,boolean> | map with information on foreign dominated industry knowing percentile .5, .75, .9, .95 of sales                                                                                                           |
| 65 | dominated_capital_for_i     | map<double,boolean> | map with information on foreign dominated industry knowing percentile .5, .75, .9, .95 of capital                                                                                                         |
| 66 | fe_c_i                      | bigint              | City industry fixed effect                                                                                                                                                                                |
| 67 | fe_t_i                      | bigint              | year industry fixed effect                                                                                                                                                                                |
| 68 | fe_c_t                      | bigint              | city industry fixed effect                                                                                                                                                                                |
