...
| 23 | sales_assets_andersen_fcit | decimal(21,5) | Sales divided by total asset                                                                                                                                        |
| 24 | return_on_asset_fcit       | decimal(21,5) | sales - (主营业务成本 (c108) + 营业费用 (c113) + 管理费用 (c114) + 财产保险费 (c116) + 劳动、失业保险费 (c118)+ 财务费用 (c124) + 本年应付工资总额 (wage)) /toasset |
| 25 | liabilities_assets_fcit    | decimal(21,5) | (流动负债合计 (c95) + 长期负债合计 (c97)) / toasset                                                                                                                 |
| 26 | quick_ratio_fcit           | decimal(21,5) | (cuasset-存货 (c81) ) / 流动负债合计 (c95)                                                                                                                          |
| 27 | current_ratio_fcit         | decimal(21,5) | cuasset/流动负债合计 (c95)                                                                                                                                          |
| 28 | fe_c_i                     | bigint        | City industry fixed effect                                                                                                                                          |
| 29 | fe_t_i                     | bigint        | year industry fixed effect                                                                                                                                          |
| 30 | fe_c_t                     | bigint        | city industry fixed effect                                                                                                                                          |
