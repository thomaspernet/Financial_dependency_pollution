...
| 37 | size_asset_f                | map<double,boolean> | if firm s asset tangibility average is above average of firm s decile then firm is large                                                                            |
| 38 | size_output_f               | map<double,boolean> | if firm s ouptut average is above average of firm s decile then firm is large                                                                                       |
| 39 | size_employment_f           | map<double,boolean> | if firm s employment average is above average of firm s decile then firm is large                                                                                   |
| 40 | size_capital_f              | map<double,boolean> | if firm s capital average is above average of firm s decile then firm is large                                                                                      |
| 41 | size_sales_f                | map<double,boolean> | if firm s sale is above average of firm s decile then firm is large                                                                                                 |
| 42 | fe_c_i                      | bigint              | City industry fixed effect                                                                                                                                          |
| 43 | fe_t_i                      | bigint              | year industry fixed effect                                                                                                                                          |
| 44 | fe_c_t                      | bigint              | city industry fixed effect                                                                                                                                          |
