...
| 22 | sales_assets_andersen_ci           | double | Sales over asset                                                                                                                                                    |
| 23 | std_sales_assets_andersen_ci       | double | standaridzed values (x - x mean) / std)                                                                                                                             |
| 24 | account_paybable_to_asset_ci       | double | (\Delta 应付帐款  (c96))/ (\Delta (toasset))                                                                                                                        |
| 25 | std_account_paybable_to_asset_ci   | double | standaridzed values (x - x mean) / std)                                                                                                                             |
| 26 | asset_tangibility_ci               | double | Total fixed assets - Intangible assets                                                                                                                              |
| 27 | std_asset_tangibility_ci           | double | standaridzed values (x - x mean) / std)                                                                                                                             |
| 28 | rd_intensity_ci                    | double | rdfee/全年营业收入合计 (c64)                                                                                                                                        |
| 29 | std_rd_intensity_ci                | double | standaridzed values (x - x mean) / std)                                                                                                                             |
| 30 | inventory_to_sales_ci              | double | 存货 (c81) / sales                                                                                                                                                  |
| 31 | std_inventory_to_sales_ci          | double | standaridzed values (x - x mean) / std)                                                                                                                             |
...
| 24 | cash_over_curasset_ci              | double        | (其中：短期投资 (c79) - 应收帐款 (c80) - 存货 (c81) - 其中：产成品 (c82)) /current asset                                                                            |
| 25 | std_cash_over_curasset_ci          | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 26 | working_capital_ci                 | double        | cuasset- 流动负债合计 (c95)                                                                                                                                         |
| 27 | std_working_capital_ci             | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 28 | working_capital_requirement_ci     | double        | 存货 (c81) + 应收帐款 (c80) - 应付帐款  (c96)                                                                                                                       |
| 29 | std_working_capital_requirement_ci | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 30 | current_ratio_ci                   | double        | cuasset/流动负债合计 (c95)                                                                                                                                          |
| 31 | std_current_ratio_ci               | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 32 | quick_ratio_ci                     | double        | (cuasset-存货 (c81) ) / 流动负债合计 (c95)                                                                                                                          |
| 33 | std_quick_ratio_ci                 | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 34 | cash_ratio_ci                      | double        | 1 - (cuasset -  其中：短期投资 (c79) - 应收帐款 (c80) - 存货 (c81)/ 流动负债合计 (c95)                                                                              |
| 35 | std_cash_ratio_ci                  | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 36 | liabilities_assets_ci              | double        | 1- (流动负债合计 (c95) + 长期负债合计 (c97)) / toasset                                                                                                              |
| 37 | std_liabilities_assets_ci          | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 38 | reverse_liabilities_assets_ci      | double        | 1 - liabilities_assets_ci                                                                                                                                           |
| 39 | reverse_std_liabilities_assets_ci  | double        | 1-standaridzed values (x - x mean) / std)                                                                                                                           |
| 40 | sales_assets_andersen_ci           | double        | 全年营业收入合计 (c64) /(toasset)                                                                                                                                   |
| 41 | std_sales_assets_andersen_ci       | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 42 | return_on_asset_ci                 | double        | sales - (主营业务成本 (c108) + 营业费用 (c113) + 管理费用 (c114) + 财产保险费 (c116) + 劳动、失业保险费 (c118)+ 财务费用 (c124) + 本年应付工资总额 (wage)) /toasset |
| 43 | std_return_on_asset_ci             | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 44 | sales_assets_ci                    | double        | 全年营业收入合计 (c64) /(\Delta toasset/2)                                                                                                                          |
| 45 | std_sales_assets_ci                | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 46 | account_paybable_to_asset_ci       | double        | (\Delta 应付帐款  (c96))/ (\Delta (toasset))                                                                                                                        |
| 47 | std_account_paybable_to_asset_ci   | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 48 | asset_tangibility_ci               | double        | Total fixed assets - Intangible assets                                                                                                                              |
| 49 | std_asset_tangibility_ci           | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 50 | rd_intensity_ci                    | double        | rdfee/全年营业收入合计 (c64)                                                                                                                                        |
| 51 | std_rd_intensity_ci                | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
| 52 | inventory_to_sales_ci              | double        | 存货 (c81) / sales                                                                                                                                                  |
| 53 | std_inventory_to_sales_ci          | double        | standaridzed values (x - x mean) / std)                                                                                                                             |
